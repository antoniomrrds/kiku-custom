...
which depends on other ad-hoc scripts such as `preprocess/scrap-jpdb.ts`, `preprocess/scrap-wk.ts`, `preprocess/parse-jmdict.ts`, and `preprocess/parse-kanji-vg.ts`
