...
export const paths = {
  ...
  "@/.jpdb/kanji-by-frequency/kyoiku.html": p(
    ".jpdb/kanji-by-frequency/kyoiku.html",
  ),
  "@/.jpdb/kanji-by-frequency/joyo.html": p(
    ".jpdb/kanji-by-frequency/joyo.html",
  ),
  "@/.jpdb/kanji-by-frequency/jinmeiyo.html": p(
    ".jpdb/kanji-by-frequency/jinmeiyo.html",
  ),
  "@/.jpdb/kanji-by-frequency/hyogai.html": p(
    ".jpdb/kanji-by-frequency/hyogai.html",
  ),
  "@/.jpdb/kanji-by-frequency/kyoiku.json": p(
    ".jpdb/kanji-by-frequency/kyoiku.json",
  ),
  "@/.jpdb/kanji-by-frequency/joyo.json": p(
    ".jpdb/kanji-by-frequency/joyo.json",
  ),
  "@/.jpdb/kanji-by-frequency/jinmeiyo.json": p(
    ".jpdb/kanji-by-frequency/jinmeiyo.json",
  ),
  "@/.jpdb/kanji-by-frequency/hyogai.json": p(
    ".jpdb/kanji-by-frequency/hyogai.json",
  ),
